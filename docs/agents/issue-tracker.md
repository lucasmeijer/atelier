...
Wayfinder maps and decision tickets for this repo live as GitHub issues. Use the `gh` CLI for all operations.
...
## When a Wayfinder skill says "publish to the issue tracker"

Create a GitHub issue.

## When a Wayfinder skill says "fetch the relevant ticket"
