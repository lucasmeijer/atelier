...
beforeAll(async () => {
  ...
  const activityButtonStyle = await Bun.file(new URL("../../../packages/design-system/src/activity-button/activity-button.css", import.meta.url)).text();
  ...
  const dialogStyle = await Bun.file(new URL("../../../packages/design-system/src/dialog/dialog.css", import.meta.url)).text();
  const panelStyle = await Bun.file(new URL("../../../packages/design-system/src/panel/panel.css", import.meta.url)).text();
  const perimeterButtonStyle = await Bun.file(new URL("../../../packages/design-system/src/perimeter-button/perimeter-button.css", import.meta.url)).text();
