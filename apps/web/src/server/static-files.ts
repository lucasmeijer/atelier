...
export const fingerprintedStaticFiles: StaticFileRegistry = {
  ...
  "/autocomplete.css": { url: new URL("../../../../packages/design-system/src/autocomplete/autocomplete.css", import.meta.url), contentType: "text/css; charset=utf-8" },
  ...
  "/button.css": { url: new URL("../../../../packages/design-system/src/button/button.css", import.meta.url), contentType: "text/css; charset=utf-8" },
  "/button-group.css": { url: new URL("../../../../packages/design-system/src/button-group/button-group.css", import.meta.url), contentType: "text/css; charset=utf-8" },
  ...
  "/floating-surface.css": { url: new URL("../../../../packages/design-system/src/floating-surface/floating-surface.css", import.meta.url), contentType: "text/css; charset=utf-8" },
  ...
  "/popup.css": { url: new URL("../../../../packages/design-system/src/popup/popup.css", import.meta.url), contentType: "text/css; charset=utf-8" },
