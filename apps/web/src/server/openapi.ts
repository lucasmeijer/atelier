...
export function atelierOpenApi(commands: WorkspaceModuleCommandHandler[]) {
  ...
  return {
    ...
    paths: {
      ...
      "/workspaces/{id}/work-views/reorder": { post: { summary: "Reorder a typed Work view", parameters: [workspaceId], requestBody: jsonBody({ type: "object", required: ["reference", "index"], properties: { reference: { $ref: "#/components/schemas/WorkViewReference" }, index: { type: "integer", minimum: 0 } }, additionalProperties: false }), responses: jsonResponse("Work views reordered", { $ref: "#/components/schemas/WorkViewsEnvelope" }) } },
