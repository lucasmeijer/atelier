...
interface Options { serverContainer: string; targetImage: string; returnHost: string }
...
async function run(): Promise<void> {
  try {
    ...
    const createArgs = replacementCreateArgs({ ...inspect, Config: { ...inspect.Config, Image: options.targetImage } });
