...
describe("dialogHtml", () => {
  ...
  test("uses the default close label and omits optional identity and footer markup", () => {
    const html = dialogHtml({ element: {}, titleHtml: "Command", bodyHtml: "Results" });
